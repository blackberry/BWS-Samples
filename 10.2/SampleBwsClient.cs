...
namespace Rim.Bws.Samples
{
    class SampleBwsClient
    {
        ...
        private const string ClientVersion = "10.2.0";
        ...
        private static DeviceActivationType CreateNewUserDeviceActivationType = null;
        ...
        private static bool DefaultDeviceActivationTypeExists = false; 
        ...
        public static User GetUser()
        {
            ...
            {
                logMessage("Warning: Email Address \"{0}\" is not enclosed in double-quotes. A substring match will occur "
					+ "(or a prefix match if the value starts with a double-quote).", DisplayUserDetailsEmail);
            }
        ...
        public static bool GetSystemInfo()
        {
            ...
            if (response.returnStatus.code.Equals("SUCCESS"))
            {
                if (response.properties != null && response.properties.Length > 0)
                {
                    ...
                    {
                        if (property.name.Equals("Default Device Activation Type"))
                        {
                            DefaultDeviceActivationTypeExists = true;
                        }
