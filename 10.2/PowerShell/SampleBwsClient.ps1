...
<#  
# 1.) Gernerate proxy files for BWS and BWSUtil web services.
...
# Example  wsdl /sharetypes /o:C:\Temp\BWSServices.cs https://server1.net:38443/enterprise/admin/ws?wsdl https://server1.net:38443/enterprise/admin/util/ws?wsdl
#
