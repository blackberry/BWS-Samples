 ...
 * Tested with Apache CXF 3.1.7, recommended to use Apache CXF 3.1.7 or later.
 *
...
public class AuthenticationSample {
    ...
    private final static String CLIENT_VERSION = "<Client Version>"; // e.g. CLIENT_VERSION = "12.6.0"

    // The enum used to determine the current server type.
    private enum ServerType{ Unknown, BDS, UDS, BES12 };

    // Enum used to determine if the server used in this execution is BES12/UEM, BDS or UDS
