...
namespace Rim.Bws.Samples
{
    class SampleBwsClient
    {
        ...
        private const string ClientVersion = "12.0.0";
        ...
        private static string BWSHostName = null; // e.g. BWSHostName = "server01.yourcompany.net:18084".        
        ...
        static int Main(string[] args)
        {
            ...
            // Hostname to use when connecting to web service.  Includes port      
            BWSHostName = "<BWSHostName>"; // e.g. BWSHostName = "server01.yourcompany.net:18084".        
