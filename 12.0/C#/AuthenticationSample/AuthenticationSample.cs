...
namespace CodeSample
{
    class AuthenticationSample
    {
        ...
        private const string CLIENT_VERSION = "<Client Version>"; // e.g. CLIENT_VERSION = "12.0.0"
        ...
        static int Main(string[] args)
        {
            ...
            bool useADSSO = false; // Active Directory with Single Sign On credentials
