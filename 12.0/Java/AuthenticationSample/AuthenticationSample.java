 ...
 * Tested with Apache CXF 2.3.3, recommended to use Apache CXF 2.3.3 or later.
 * 
 * Tested with Apache commons codec 1.9, recommended to use Apache commons codec 1.9 or later.
 *
...
public class AuthenticationSample {
    ...
    private final static String CLIENT_VERSION = "<Client Version>"; // e.g. CLIENT_VERSION = "12.0.0"
    
    // The enum used to determine the current server type.
    private enum ServerType{ Unknown, BDS, UDS, BES12 };

    // Enum used to determine if the server used in this execution is BES12, BDS or UDS
    ...
    public static String getBase64EncodedSpnegoToken(String username, String domain, String kerberosRealm,
        ...
        if (token != null) {
            returnValue = Base64.encodeBase64String(token);
        }
    ...
    public static void main(String[] args) throws IOException {
        ...
        // management console in BDS and UDS.  Default ports: BDS=38443, UDS=18082, BES12=18084
        ...
        boolean useADSSO = false; // Active Directory with Single Sign On credentials
    ...
    private static boolean demonstrateActiveDirectoryAuthentication(String bwsHostname, String bwsPort, 
        ...
        // Only BDS and BES12 require domain for authentication
