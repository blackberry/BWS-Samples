...
namespace CodeSample
{
    class AuthenticationSample
    {
        ...
        private const string CLIENT_VERSION = "<Client Version>"; // e.g. CLIENT_VERSION = "6.2.0"        
        ...
        static int Main(string[] args)
        {
            ...
            // e.g. bwsHostname = "server01.example.net". Must contain the fully qualified domain name.       
            ...
            bool useBAS = true; // BlackBerry Administration Service
            bool useAD = true; // Active Directory
            bool useSSO = true; // Single Sign On
            ...
            try
            {
                ...
                {
                    returnCode = (demonstrateActiveDirectoryAuthentication(bwsHostname, bwsPort)) ? SUCCESS
                            : FAILURE;
                    logMessage("");
                }
                ...
                {
                    returnCode = (demonstrateSingleSignOnAuthentication(bwsHostname, bwsPort)) ? SUCCESS
                            : FAILURE;
                    logMessage("");
                }
            }
        ...
        /// <summary>
        /// Demonstrates BlackBerry Administration Service Authentication. The required fields are:
        /// username, and password. Fields denoted by "<value>" must be manually set.
        /// </summary>
        /// 
        ...
        /// <summary>
        /// Demonstrates Active Directory Authentication. The required fields are: domain, username, and
        /// password. Fields denoted by "<value>" must be manually set.
        /// </summary>
        /// 
        /// <returns>Returns true if authenticated successfully, false otherwise.</returns>
        private static bool demonstrateActiveDirectoryAuthentication(String bwsHostname,
            String bwsPort)
        {
        ...
        /// <summary>
        /// Demonstrates Single Sign On Authentication. The required fields are: username, domain, realm,
        /// and domainController. The sample below automatically acquires the username and domain from
        /// the currently logged in user's environment.
        /// </summary>
        /// 
        /// <returns>Returns true if authenticated successfully, false otherwise.</returns>
        private static bool demonstrateSingleSignOnAuthentication(String bwsHostname,
            String bwsPort)
        {
            ...
            String activeDirectoryDomain =
                    System.Environment.GetEnvironmentVariable("USERDNSDOMAIN");// e.g. "example.net"
            CredentialType credentialType = new CredentialType();
        ...
        private static bool demonstrateBwsSetupAndAuthenticatedCall(String bwsHostname,
            String bwsPort, String username, String password, String activeDirectoryDomain,
            String authenticatorName, CredentialType credentialType)
        {
